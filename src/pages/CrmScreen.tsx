        ...
        <div className="flex-1 overflow-y-auto bg-[#faf9f8] p-6">
          ...
          {activeTab === "Post Ruling" && <div className="max-w-7xl mx-auto">
            <div className="flex flex-col gap-6">
              {/* Top row - Appeal Decision Checklist and Notes side by side */}
              ...
              {/* Court Ordered Hearing - Below both sections with 5cm (~190px) margin */}
              {remandChecked && <div className="mt-12 bg-white border border-[#edebe9] rounded max-w-md">
                  <div className="px-4 py-3 border-b border-[#edebe9]">
