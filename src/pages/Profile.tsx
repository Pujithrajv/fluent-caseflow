...
import { ChevronDown, ArrowLeft, Info, HelpCircle, Edit, Trash2, Save, X, Plus, AlertTriangle, ChevronRight } from "lucide-react";
...
const Profile = () => {
  ...
  // Organization2 Tab Navigation State
  type Organization2ViewType = "department" | "division" | "bureau";
  const [org2CurrentView, setOrg2CurrentView] = useState<Organization2ViewType>("department");
  const [org2SelectedDivisionId, setOrg2SelectedDivisionId] = useState<string | null>(null);
  const [org2SelectedBureauId, setOrg2SelectedBureauId] = useState<string | null>(null);
  ...
  // Organization2 Navigation Functions
  const navigateToOrg2Division = (divisionId: string) => {
    setOrg2SelectedDivisionId(divisionId);
    setOrg2CurrentView("division");
  };

  const navigateToOrg2Bureau = (bureauId: string) => {
    setOrg2SelectedBureauId(bureauId);
    setOrg2CurrentView("bureau");
  };

  const navigateToOrg2Overview = () => {
    setOrg2CurrentView("department");
    setOrg2SelectedDivisionId(null);
    setOrg2SelectedBureauId(null);
  };

  const getOrg2CurrentDivision = () => org2Divisions.find(d => d.id === org2SelectedDivisionId);
  const getOrg2CurrentBureau = () => org2Bureaus.find(b => b.id === org2SelectedBureauId);
  const getOrg2BureausForDivision = (divId: string) => org2Bureaus.filter(b => b.divisionId === divId);
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <Tabs defaultValue="profile" className="w-full">
          ...
          <TabsContent value="organization2" className="mt-6">
                          ...
                          <TableRow key={div.id} className="hover:bg-gray-50">
                            ...
                            <TableCell>
                              <Button 
                                variant="link" 
                                size="sm" 
                                onClick={() => navigateToOrg2Division(div.id)}
            ...
            {/* Division View */}
            {org2CurrentView === "division" && org2SelectedDivisionId && (() => {
              const division = getOrg2CurrentDivision();
              if (!division) return null;
              return (
                <div className="max-w-screen-xl mx-auto space-y-6">
                  {/* Breadcrumb */}
                  <div className="flex items-center gap-2 text-sm text-gray-600 bg-white p-4 rounded-lg shadow-sm border">
                    <button onClick={navigateToOrg2Overview} className="hover:text-[#0078D4] hover:underline">Home</button>
                    <ChevronRight className="h-4 w-4" />
                    <button onClick={navigateToOrg2Overview} className="hover:text-[#0078D4] hover:underline">Department of Natural Resources</button>
                    <ChevronRight className="h-4 w-4" />
                    ...
                    <CardContent className="pt-6">
                      <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                        <div>
                          ...
                          <Input value={division.name} disabled className="mt-1" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">Parent Entity</Label>
                          <Input value="Department of Natural Resources" disabled className="mt-1 bg-muted" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">Participation Group</Label>
                  ...
                  <Card className="shadow-sm border">
                    ...
                    <CardContent className="pt-6">
                      <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                        <div>
                          <Label className="text-sm font-medium text-gray-700">Street</Label>
                          <Input value={division.address} disabled className="mt-1" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">City</Label>
                          <Input value={division.city} disabled className="mt-1" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">State</Label>
                          <Input value={division.state} disabled className="mt-1" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">Postal Code</Label>
                          <Input value={division.zip} disabled className="mt-1" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">Phone</Label>
                          <Input value={division.phone} disabled className="mt-1" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">Primary Contact</Label>
                          <Input value={division.primaryContact} disabled className="mt-1" />
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="shadow-sm border">
                    ...
                    <CardContent className="p-0">
                      <Table>
                        ...
                        <TableBody>
                          {getOrg2BureausForDivision(org2SelectedDivisionId).map((bureau) => (
                            <TableRow key={bureau.id} className="hover:bg-gray-50">
                              ...
                              <TableCell>
                                <Button 
                                  variant="link" 
                                  size="sm" 
                                  onClick={() => navigateToOrg2Bureau(bureau.id)}
                                  className="text-[#0078D4] hover:text-[#106EBE]"
                                >
                                  View Details
                                </Button>
            ...
            {/* Bureau View */}
            {org2CurrentView === "bureau" && org2SelectedBureauId && (() => {
              const bureau = getOrg2CurrentBureau();
              const division = getOrg2CurrentDivision();
              ...
              return (
                <div className="max-w-screen-xl mx-auto space-y-6">
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-600 bg-white p-4 rounded-lg shadow-sm border">
                    ...
                    <button onClick={navigateToOrg2Overview} className="hover:text-[#0078D4] hover:underline">Department of Natural Resources</button>
                    <ChevronRight className="h-4 w-4" />
                    <button onClick={() => navigateToOrg2Division(division.id)} className="hover:text-[#0078D4] hover:underline">{division.name}</button>
                    <ChevronRight className="h-4 w-4" />
                    ...
                    <CardContent className="pt-6">
                      <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                        <div>
                          ...
                          <Input value={bureau.name} disabled className="mt-1" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">Parent Entity</Label>
                          <Input value={division.name} disabled className="mt-1 bg-muted" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">Participation Group</Label>
                          <Input value="State Entities" disabled className="mt-1 bg-muted" />
                  ...
                  <Card className="shadow-sm border">
                    ...
                    <CardContent className="pt-6">
                      <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                        <div>
                          <Label className="text-sm font-medium text-gray-700">Street</Label>
                          <Input value={bureau.address} disabled className="mt-1" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">City</Label>
                          <Input value={bureau.city} disabled className="mt-1" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">State</Label>
                          <Input value={bureau.state} disabled className="mt-1" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">Postal Code</Label>
                          <Input value={bureau.zip} disabled className="mt-1" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">Phone</Label>
                          <Input value={bureau.phone} disabled className="mt-1" />
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700">Primary Contact</Label>
                          <Input value={bureau.primaryContact} disabled className="mt-1" />
                        </div>
                      </div>
                    </CardContent>
                  </Card>
