...
import { HelpCircle, Plus, Edit, Trash2, Calendar as CalendarIcon } from "lucide-react";
...
export function InterrogatoriesQuestionsTab({ onDataChange, data }: InterrogatoriesQuestionsTabProps) {
  ...
  const [replyDueDate, setReplyDueDate] = useState<Date>();
    ...
    <div className="space-y-8">
      ...
      <Card className="shadow-fluent-8">
        ...
        <CardContent className="space-y-8">
          ...
          {/* What persons to receive Section */}
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Label className="font-fluent text-sm font-semibold">What persons to receive</Label>
                <Tooltip>
                  <TooltipTrigger>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="font-fluent font-semibold">Email Address</TableHead>
          ...
          {/* When is reply due Section */}
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              <Label className="font-fluent text-sm font-semibold">When is reply due</Label>
              <Tooltip>
                <TooltipTrigger>
                  <HelpCircle className="h-4 w-4 text-muted-foreground" />
                </TooltipTrigger>
            ...
            <Popover>
              <PopoverTrigger asChild>
                ...
                >
                  <CalendarIcon className="mr-2 h-4 w-4" />
                  {replyDueDate ? format(replyDueDate, "PPP") : <span>Pick a date</span>}
                </Button>
              </PopoverTrigger>
              <PopoverContent className="w-auto p-0" align="start">
                <Calendar
                  mode="single"
                  selected={replyDueDate}
                  onSelect={setReplyDueDate}
                  initialFocus
                  className="p-3 pointer-events-auto"
                />
              </PopoverContent>
